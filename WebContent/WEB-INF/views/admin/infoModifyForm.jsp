		...
		<form method="post" onSubmit="return checkSubmit();" action="infoWritePro.do">
			...
			<div class="select-wrap" style="margin-top:30px;">
				<div class="input-group">
					<input type="text" name="title" class="form-control" id="title" value="[수정] ${infodto.title }" required="" style="border: 1px solid #ddd;border-radius: 1em;">
				</div>
			</div>

				<div><hr style="height:3px;"></div>
				<div class="form-group">
					<textarea class="form-control" name="content" id="contentTextArea" rows="8">${infodto.content }</textarea>
				</div>
			</div>
			<div class="btn-wrap">
					<input type="button" class="btn" id="modifyQnaBtn" value="수정"/>				
					<button type="button" class="btn" onclick="window.location='/wiicar/admin/infoContent.do?num=${infodto.num}'">수정 취소</button>
			</div>
		</form>
	</div>
